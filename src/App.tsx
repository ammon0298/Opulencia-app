...
export const App: React.FC = () => {
  ...
  const handleLogin = (u: string, p: string) => {
    ...
    if (user) {
       ...
       setAuthError('Credenciales incorrectas. Verifique usuario y contraseña.');
    }
  };
  ...
  // Wrapper para navegación que limpia filtros si se va al listado general
  ...
  // Filtered Data based on selection and permissions
     ...
     switch(currentView) {
        ...
        case 'credit_details':
           ...
           return <ClientDetails 
              ...
              onMarkAsLost={(cid) => {
                 setCredits(prev => prev.map(c => c.id === cid ? { ...c, status: 'Lost' } : c));
                 setCurrentView('credits');
              }}
           />;
        case 'credit_visits':
